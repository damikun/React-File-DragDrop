...
<p align="center">
  ...
  <p align="center">
   Preview of file drag drop react component
    ...
    <p align="center">
   This is frontend file dropper include axios under the hood to send file and get its token. Token is use as temporary user and file identifier and is generated by backend app. For frontend component ussage is not necessary, it is just ilustrating the full concept of uploading files for certain project for app..
  </p>
</p>
